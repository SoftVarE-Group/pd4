...
("cache-impl", boost::program_options::value<std::string>()->default_value("fixed"), "cache implementation")
("cache-fixed-size", boost::program_options::value<size_t>()->default_value( (1ull<<30)*12 ) , "fixed cache size")
