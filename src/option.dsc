...
("proj-backup-scoring-method",boost::program_options::value<int>()->default_value(0),"proj backup heuristic when hypergraph partitioning fails")
("proj-backup-min-cover",boost::program_options::value<double>()->default_value(0.3),"proj backup heuristic when hypergraph partitioning fails")
("proj-backup",boost::program_options::value<std::string>()->default_value("none"),"proj backup heuristic when hypergraph partitioning fails")
...
("preproc-ve-only-simpical",boost::program_options::value<bool>()->default_value(false), "only apply ve to simpical")
("preproc-ve-prefer-simpical",boost::program_options::value<bool>()->default_value(true), "only apply ve to simpical")
...
("scoring-method-x",boost::program_options::value<int>()->default_value(1),"pvsads smx")
("scoring-method-y",boost::program_options::value<int>()->default_value(64),"pvsads smy")
("scoring-method-z",boost::program_options::value<int>()->default_value(128),"pvsads smz")
...
("cache-fixed-size", boost::program_options::value<int>()->default_value(15) , "fixed cache size in gb")
